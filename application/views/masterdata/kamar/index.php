                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                     <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="<?= base_url('master/kamar/tambah')?>" class="d-none d-sm-inline-block btn btn-primary shadow-sm"><i
                                    ...
                                    <?php $i =1; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= base_url('master/kamar/edit/'). $r['id'] ; ?>" class="btn btn-warning btn-circle"><i class="fas fa-edit"></i></a>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Hapus Data <?= $r['kode_kamar']?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
         </button>
      </div>
      <form action="<?= base_url('master/kamar/delete/'.$r['id']); ?>" method="post">
