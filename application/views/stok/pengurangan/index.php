        <!-- End of Topbar -->
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <?php 
                       ...
                       {
                            echo ' <div class="alert alert-danger alert-dismissible" role="alert">
                            <strong>Sukses! </strong>'.$this->session->flashdata('failed');
                            echo '</div>';
                       }
                    ?>
                                    ...
                                    <?php $i =1; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- <a href="<?= base_url('stok/pengurangan/edit/'). $r['id'] ; ?>" class="btn btn-warning btn-circle"><i class="fas fa-edit"></i></a> -->
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="card-body">
            ...
            <div class="form-group row">
                <label for="email" class="col-sm-2 col-form-label">Nama Pasien</label> 
                    <div class="col-sm-5">
                        <input type="text" class="form-control" id="kode_obat"  name="kode_obat" value="<?= $r['nama_pasien']; ?>" readonly> 
                    </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
             ...
             <div class="form-group row">
                <label for="email" class="col-sm-2 col-form-label">Tanggal Keluar</label> 
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="kode_obat"  name="kode_obat" value="<?= $r['tanggal_keluar']; ?>" readonly> 
                    </div>
            </div>
        </div>
      </div>
...
<div class="modal fade" id="tambahStok">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form action="<?= base_url('stok/pengurangan/tambah'); ?>" method="post">
      <div class="modal-body">
          <div class="form-group row">
                <label for="name" class="col-sm-2 col-form-label">Nama Obat</label> 
                    ...
                    <select class="form-control" aria-label="Default select example" name="id_obat">
                      <?php foreach ($obat as $o) : ?>
                                <option value="<?= $o['id']?>" selected><?= $o['kode_obat']?> | <?= $o['nama_obat']?> | <?= $o['stok']?></option>
                               <?php endforeach; ?>
                        </select>
                    </div>
            </div>
            <div class="form-group row">
                <label for="name" class="col-sm-2 col-form-label">Nama Pasien</label> 
                    <div class="col-sm-10">
                    <select class="form-control" aria-label="Default select example" name="id_pasien">
                      <?php foreach ($pasien as $o) : ?>
                                <option value="<?= $o['id']?>" selected><?= $o['kode_pasien']?> | <?= $o['nama_pasien']?></option>
                               <?php endforeach; ?>
                        </select>
                    </div>
            </div>
        ...
        <div class="form-group row">
            <label for="name" class="col-sm-2 col-form-label">Tanggal Keluar</label> 
                <div class="col-sm-10">
