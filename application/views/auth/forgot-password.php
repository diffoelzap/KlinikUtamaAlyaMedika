                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                ...
                                if ($this->session->flashdata('check_email')) 
                                {
                                        ...
                                        <strong>Failed! </strong>'.$this->session->flashdata('check_email');
                                        echo '</div>';
                                }else if ($this->session->flashdata('email_not_registered')) 
                                {
                                        echo ' <div class="alert alert-danger alert-dismissible" role="alert">
                                        <strong>Failed! </strong>'.$this->session->flashdata('email_not_registered');
                                        echo '</div>';
                                }
                                ?>
