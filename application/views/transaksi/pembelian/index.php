                                    ...
                                    <?php $i =1; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- <a href="<?= base_url('transaksi/pembelian/edit/'). $r['id'] ; ?>" class="btn btn-warning btn-circle"><i class="fas fa-edit"></i></a> -->
...
<div class="modal fade" id="tambahStok">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form action="<?= base_url('transaksi/pembelian/tambah'); ?>" method="post">
      <div class="modal-body">
          <div class="form-group row">
